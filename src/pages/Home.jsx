...
import { getAllCourses, getPopularCourses, getTopEnrollCoursesSlice } from '../services/operations/pageAndComponentData'
...
const Home = () => {
    ...
    const { popularCourses, topEnrollCourses, allCourses } = useSelector((state) => state.course);
    ...
    useEffect(() => {
        const fetchCatalogPageData = async () => {
            await getPopularCourses(dispatch);
            await getTopEnrollCoursesSlice(dispatch);
            ...
            <div className=' '>
                ...
                <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
                    ...
                    <div className=' mx-auto box-content w-full max-w-maxContentTab px- py-12 lg:max-w-maxContent'>
                        ...
                        <Course_Slider Courses={topEnrollCourses} />
                    </div>
                    <div className=' mx-auto box-content w-full max-w-maxContentTab px- py-12 lg:max-w-maxContent'>
                        <h2 className='text-white mb-6 text-2xl '>
                            All Courses 
